...
public:
    ...
    inline void SetGatherTilingData(InnerMoeV2GatherOutComputeTilingData *tilingData, int64_t perCoreRows,
                                    int64_t lastCoreRows, int64_t cols);
    inline void SetGatherTilingDataCols(InnerMoeV2GatherOutComputeTilingData *tilingData, int64_t baseMaxCols,
                                        int64_t cols);
    ...
    inline void CopyGatherOutTiling(InnerMoeV2GatherOutComputeTilingData &dst,
