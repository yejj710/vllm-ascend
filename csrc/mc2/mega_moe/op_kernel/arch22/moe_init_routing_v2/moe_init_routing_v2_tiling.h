...
void MoeInitRoutingV2TilingBase::ShowTilingData()
{
    OP_LOGD(opName,
            ...
            moeInitRoutingTilingData.coreNum, moeInitRoutingTilingData.n, moeInitRoutingTilingData.cols,
            moeInitRoutingTilingData.k, moeInitRoutingTilingData.expertCapacity, moeInitRoutingTilingData.expertNum,
