...
#define OP_LOGE_LIBOPAPI_REPORT(opName, fmt, ...)                                                                      \
    DOplogSub(static_cast<int32_t>(OP_ID), OPAPI_SUBMOD_NAME, OP_LOG_ERROR, "[%s][%lu] OpName:[%s] " fmt,              \
              __FUNCTION__, op::OpLog::GetTid(), opName, ##__VA_ARGS__)
#else
#define OP_LOGE_LIBOPAPI_REPORT(opName, fmt, ...) D_OP_LOGE(Ops::Base::GetOpInfo(opName), fmt, ##__VA_ARGS__)
...
#define OP_LOGE_FOR_INVALID_SHAPE(opName, paramName, incorrectShape, correctShape)                                     \
    do {                                                                                                               \
        ...
        REPORT_INNER_ERR_MSG("EZ0008", "Parameter %s of operator %s has incorrect shape %s. It should be %s.",         \
                             _safe_paramName_.c_str(), _safe_opName_.c_str(), _safe_incorrectShape_.c_str(),           \
                             _safe_correctShape_.c_str());                                                             \
    } while (0)
...
#define OP_LOGE_FOR_INVALID_SHAPE_WITH_REASON(opName, paramName, incorrectShape, reason)                               \
    do {                                                                                                               \
        ...
        REPORT_INNER_ERR_MSG("EZ0009", "Parameter %s of operator %s has incorrect shape %s. Reason: %s.",              \
                             _safe_paramName_.c_str(), _safe_opName_.c_str(), _safe_incorrectShape_.c_str(),           \
                             _safe_reason_.c_str());                                                                   \
    } while (0)
...
#define OP_LOGE_FOR_INVALID_SHAPES_WITH_REASON(opName, paramNames, incorrectShapes, reason)                            \
    do {                                                                                                               \
        ...
        REPORT_INNER_ERR_MSG("EZ0010", "Parameters %s of operator %s have incorrect shapes %s. Reason: %s.",           \
                             _safe_paramNames_.c_str(), _safe_opName_.c_str(), _safe_incorrectShapes_.c_str(),         \
                             _safe_reason_.c_str());                                                                   \
    } while (0)
...
#define OP_LOGE_FOR_INVALID_SHAPEDIM(opName, paramName, incorrectDim, correctDim)                                      \
    do {                                                                                                               \
        ...
        OP_LOGE_LIBOPAPI_REPORT(                                                                                       \
            _safe_opName_.c_str(), "Parameter %s of operator %s has incorrect shape dim %s. It should be %s.",         \
            _safe_paramName_.c_str(), _safe_opName_.c_str(), _safe_incorrectDim_.c_str(), _safe_correctDim_.c_str());  \
        REPORT_INNER_ERR_MSG("EZ0011", "Parameter %s of operator %s has incorrect shape dim %s. It should be %s.",     \
                             _safe_paramName_.c_str(), _safe_opName_.c_str(), _safe_incorrectDim_.c_str(),             \
...
#define OP_LOGE_FOR_INVALID_SHAPEDIM_WITH_REASON(opName, paramName, incorrectDim, reason)                              \
    do {                                                                                                               \
        ...
        REPORT_INNER_ERR_MSG("EZ0012", "Parameter %s of operator %s has incorrect shape dim %s. Reason: %s.",          \
                             _safe_paramName_.c_str(), _safe_opName_.c_str(), _safe_incorrectDim_.c_str(),             \
                             _safe_reason_.c_str());                                                                   \
    } while (0)
...
#define OP_LOGE_FOR_INVALID_SHAPEDIMS_WITH_REASON(opName, paramNames, incorrectDims, reason)                           \
    do {                                                                                                               \
        ...
        REPORT_INNER_ERR_MSG("EZ0013", "Parameters %s of operator %s have incorrect shape dims %s. Reason: %s.",       \
                             _safe_paramNames_.c_str(), _safe_opName_.c_str(), _safe_incorrectDims_.c_str(),           \
                             _safe_reason_.c_str());                                                                   \
    } while (0)
...
#define OP_LOGE_FOR_INVALID_SHAPESIZE(opName, paramName, incorrectSize, correctSize)                                   \
    do {                                                                                                               \
        ...
        REPORT_INNER_ERR_MSG("EZ0014", "Parameter %s of operator %s has incorrect shape size %s. It should be %s.",    \
                             _safe_paramName_.c_str(), _safe_opName_.c_str(), _safe_incorrectSize_.c_str(),            \
                             _safe_correctSize_.c_str());                                                              \
    } while (0)
...
#define OP_LOGE_FOR_INVALID_SHAPESIZE_WITH_REASON(opName, paramName, incorrectSize, reason)                            \
    do {                                                                                                               \
        ...
        REPORT_INNER_ERR_MSG("EZ0015", "Parameter %s of operator %s has incorrect shape size %s. Reason: %s.",         \
                             _safe_paramName_.c_str(), _safe_opName_.c_str(), _safe_incorrectSize_.c_str(),            \
                             _safe_reason_.c_str());                                                                   \
    } while (0)
...
#define OP_LOGE_FOR_INVALID_SHAPESIZES_WITH_REASON(opName, paramNames, incorrectSizes, reason)                         \
    do {                                                                                                               \
        ...
        REPORT_INNER_ERR_MSG("EZ0016", "Parameters %s of operator %s have incorrect shape sizes %s. Reason: %s.",      \
                             _safe_paramNames_.c_str(), _safe_opName_.c_str(), _safe_incorrectSizes_.c_str(),          \
                             _safe_reason_.c_str());                                                                   \
    } while (0)
...
#define OP_LOGE_FOR_INVALID_FORMAT(opName, paramName, incorrectFormat, correctFormat)                                  \
    do {                                                                                                               \
        ...
        REPORT_INNER_ERR_MSG("EZ0017", "Parameter %s of operator %s has incorrect format %s. It should be %s.",        \
                             _safe_paramName_.c_str(), _safe_opName_.c_str(), _safe_incorrectFormat_.c_str(),          \
                             _safe_correctFormat_.c_str());                                                            \
    } while (0)
...
#define OP_LOGE_FOR_INVALID_FORMATS_WITH_REASON(opName, paramNames, incorrectFormats, reason)                          \
    do {                                                                                                               \
        ...
        REPORT_INNER_ERR_MSG("EZ0018", "Parameters %s of operator %s have incorrect formats %s. Reason: %s.",          \
                             _safe_paramNames_.c_str(), _safe_opName_.c_str(), _safe_incorrectFormats_.c_str(),        \
                             _safe_reason_.c_str());                                                                   \
    } while (0)
...
#define OP_LOGE_FOR_INVALID_DTYPE(opName, paramName, incorrectDtype, correctDtype)                                     \
    do {                                                                                                               \
        ...
        REPORT_INNER_ERR_MSG("EZ0019", "Parameter %s of operator %s has incorrect dtype %s. It should be %s.",         \
                             _safe_paramName_.c_str(), _safe_opName_.c_str(), _safe_incorrectDtype_.c_str(),           \
                             _safe_correctDtype_.c_str());                                                             \
    } while (0)
...
#define OP_LOGE_FOR_INVALID_DTYPE_WITH_REASON(opName, paramName, incorrectDtype, reason)                               \
    do {                                                                                                               \
        ...
        REPORT_INNER_ERR_MSG("EZ0020", "Parameter %s of operator %s has incorrect dtype %s. Reason: %s.",              \
                             _safe_paramName_.c_str(), _safe_opName_.c_str(), _safe_incorrectDtype_.c_str(),           \
                             _safe_reason_.c_str());                                                                   \
    } while (0)
...
#define OP_LOGE_FOR_INVALID_DTYPES_WITH_REASON(opName, paramNames, incorrectDtypes, reason)                            \
    do {                                                                                                               \
        ...
        REPORT_INNER_ERR_MSG("EZ0021", "Parameters %s of operator %s have incorrect dtypes %s. Reason: %s.",           \
                             _safe_paramNames_.c_str(), _safe_opName_.c_str(), _safe_incorrectDtypes_.c_str(),         \
                             _safe_reason_.c_str());                                                                   \
    } while (0)
...
#define OP_LOGE_FOR_INVALID_TENSORNUM(opName, paramName, incorrectNum, correctNum)                                     \
    do {                                                                                                               \
        ...
        REPORT_INNER_ERR_MSG("EZ0022", "Parameter %s of operator %s has invalid tensor num %ld. It should be %s.",     \
                             _safe_paramName_.c_str(), _safe_opName_.c_str(), static_cast<int64_t>(incorrectNum),      \
                             _safe_correctNum_.c_str());                                                               \
    } while (0)
...
#define OP_LOGE_FOR_INVALID_TENSORNUMS_WITH_REASON(opName, paramNames, incorrectNums, reason)                          \
    do {                                                                                                               \
        ...
        REPORT_INNER_ERR_MSG("EZ0023", "Parameters %s of operator %s have invalid tensor nums %s. Reason: %s.",        \
                             _safe_paramNames_.c_str(), _safe_opName_.c_str(), _safe_incorrectNums_.c_str(),           \
                             _safe_reason_.c_str());                                                                   \
    } while (0)
...
#define OP_LOGE_FOR_INVALID_VALUE(opName, paramName, incorrectValue, correctValue)                                     \
    do {                                                                                                               \
        ...
        REPORT_INNER_ERR_MSG("EZ0024", "Parameter %s of operator %s has incorrect value %s. It should be %s.",         \
                             _safe_paramName_.c_str(), _safe_opName_.c_str(), _safe_incorrectValue_.c_str(),           \
                             _safe_correctValue_.c_str());                                                             \
    } while (0)
...
#define OP_LOGE_FOR_INVALID_LISTSIZE(opName, paramName, incorrectSize, correctSize)                                    \
    do {                                                                                                               \
        ...
        OP_LOGE_LIBOPAPI_REPORT(_safe_opName_.c_str(),                                                                 \
                                ...
                                _safe_paramName_.c_str(), _safe_opName_.c_str(), _safe_incorrectSize_.c_str(),         \
                                _safe_correctSize_.c_str());                                                           \
        REPORT_INNER_ERR_MSG("EZ0025", "Parameter %s of operator %s has incorrect element nums %s. It should be %s.",  \
                             _safe_paramName_.c_str(), _safe_opName_.c_str(), _safe_incorrectSize_.c_str(),            \
                             _safe_correctSize_.c_str());                                                              \
    } while (0)
...
#define OP_LOGE_FOR_INVALID_VALUE_WITH_REASON(opName, paramName, incorrectValue, reason)                               \
    do {                                                                                                               \
        ...
        REPORT_INNER_ERR_MSG("EZ0026", "Parameter %s of operator %s has incorrect value %s. Reason: %s.",              \
                             _safe_paramName_.c_str(), _safe_opName_.c_str(), _safe_incorrectValue_.c_str(),           \
                             _safe_reason_.c_str());                                                                   \
    } while (0)
...
#define OP_LOGE_FOR_INVALID_VALUES_WITH_REASON(opName, paramNames, incorrectValues, reason)                            \
    do {                                                                                                               \
        ...
        REPORT_INNER_ERR_MSG("EZ0027", "Parameters %s of operator %s have incorrect values %s. Reason: %s.",           \
                             _safe_paramNames_.c_str(), _safe_opName_.c_str(), _safe_incorrectValues_.c_str(),         \
                             _safe_reason_.c_str());                                                                   \
    } while (0)
...
#define OP_LOGE_FOR_INVALID_STRIDE(opName, paramName, incorrectStride, correctStride)                                  \
    do {                                                                                                               \
        ...
        REPORT_INNER_ERR_MSG("EZ0028", "Parameter %s of operator %s has incorrect stride %s, it should be %s.",        \
                             _safe_paramName_.c_str(), _safe_opName_.c_str(), _safe_incorrectStride_.c_str(),          \
                             _safe_correctStride_.c_str());                                                            \
    } while (0)
...
#define OP_LOGE_FOR_FILE_PATH(opName, filePath, reason)                                                                \
    do {                                                                                                               \
        ...
        REPORT_INNER_ERR_MSG("EZ0029", "Input path %s is invalid. Reason: %s.", _safe_filePath_.c_str(),               \
                             _safe_reason_.c_str());                                                                   \
    } while (0)
...
#define OP_LOGE_FOR_FILE_OPEN(opName, filePath, reason)                                                                \
    do {                                                                                                               \
        ...
        OP_LOGE_LIBOPAPI_REPORT(_safe_opName_.c_str(), "Failed to open file %s. Reason: %s.", _safe_filePath_.c_str(), \
                                _safe_reason_.c_str());                                                                \
        REPORT_INNER_ERR_MSG("EZ0030", "Failed to open file %s. Reason: %s.", _safe_filePath_.c_str(),                 \
                             _safe_reason_.c_str());                                                                   \
    } while (0)
...
#define OP_LOGE_FOR_FILE_PARSE(opName, fileName, reason)                                                               \
    do {                                                                                                               \
        ...
        REPORT_INNER_ERR_MSG("EZ0031", "Failed to parse file %s. Reason: %s.", _safe_fileName_.c_str(),                \
                             _safe_reason_.c_str());                                                                   \
    } while (0)
...
#define OP_LOGE_FOR_INVALID_CONFIG(opName, configFile, item, value, expect)                                            \
    do {                                                                                                               \
        ...
        REPORT_INNER_ERR_MSG(                                                                                          \
            "EZ0032", "Value %s of configuration item %s in configuration file %s is invalid, it should be %s.",       \
            _safe_value_.c_str(), _safe_item_.c_str(), _safe_configFile_.c_str(), _safe_expect_.c_str());              \
    } while (0)
...
#define OP_LOGE_FOR_INVALID_CONFIG_WITH_REASON(opName, configFile, item, value, reason)                                \
    do {                                                                                                               \
        ...
        OP_LOGE_LIBOPAPI_REPORT(_safe_opName_.c_str(),                                                                 \
                                ...
                                _safe_reason_.c_str());                                                                \
        REPORT_INNER_ERR_MSG(                                                                                          \
            "EZ0033", "Value %s of configuration item %s in configuration file %s is invalid. Reason: %s.",            \
...
#define OP_LOGE_FOR_INVALID_CONFIGS_WITH_REASON(opName, configFile, items, values, reason)                             \
    do {                                                                                                               \
        ...
        REPORT_INNER_ERR_MSG(                                                                                          \
            "EZ0034", "Values %s of configuration items %s in configuration file %s are invalid. Reason: %s.",         \
            _safe_values_.c_str(), _safe_items_.c_str(), _safe_configFile_.c_str(), _safe_reason_.c_str());            \
    } while (0)
